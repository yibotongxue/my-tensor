...
template <typename T>
void transpose_matmul(const T *A, const T *B, T *C, const int m, const int k,
...
template <typename T>
void matmul_transpose(const T *A, const T *B, T *C, const int m, const int k,
                      const int n, const int batch_count = 1,
                      const int broadcast = 0) {
  BLAS_UNIMPLEMENTION
}
...
template <typename T>
void transpose_matmul_transpose(const T *A, const T *B, T *C, const int m,
