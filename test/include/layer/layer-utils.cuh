...
#define BACKWARD_TEST(layer_class, layer_name, device)                                                         \
  ...
  {                                                                                                            \
    ...
    std::vector<float> bottom_diff(bottom->Get##device##Diff().begin(), bottom->Get##device##Diff().end());    \
    ...
    std::vector<float> new_top_data(new_top->Get##device##Data().begin(), new_top->Get##device##Data().end()); \
