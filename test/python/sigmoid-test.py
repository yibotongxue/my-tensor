...
class SigmoidTest(unittest.TestCase):
    def setUp(self):
        ...
        self.sigmoid = ts.Sigmoid()

    def test_cpu_forward(self):
        tsoutput = self.sigmoid.forward(self.tsinput)
        torchoutput = torch.nn.functional.sigmoid(self.torchinput)
    ...
    def test_cpu_backward(self):
        ...
        self.tsinput = self.sigmoid.backward(tsoutput)
